...
insert into application(id, name, code, team_id, email_group, creator, create_time, state) values
  ...
  (1, '应用2', 'applicationCode2', 2, 'department1@company.com', 'mary', now(), 2),
  (1, '应用3', 'applicationCode3', 3, 'department1@company.com', 'mark', now(), 3),
  (1, '应用4', 'applicationCode4', 4, 'department1@company.com', 'rollen', now(), 2),
  (1, '应用5', 'applicationCode5', 5, 'department1@company.com', 'linda', now(), 3),
  (1, '应用6', 'applicationCode6', 2, 'department1@company.com', 'lucy', now(), 1);
